System.register(["angular", "angular-ui-router", "ng-harmony"], function (_export) {
    var angular, router, Ctrl, _slicedToArray, _get, _inherits, _classCallCheck, _createClass, Module, StateCtrl;

    return {
        setters: [function (_angular) {
            angular = _angular["default"];
        }, function (_angularUiRouter) {
            router = _angularUiRouter["default"];
        }, function (_ngHarmony) {
